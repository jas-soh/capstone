...
void setup(void) 
{
  ...
  // ---------- Timer setup ----------
  accel_timer.every(10,sample_accel);
  accel_timer.every(200,sample_strain);
...
bool sample_accel(void *) {
  ...
  int8_t X1 = ( Wire.read()| Wire.read() << 8); // X-axis value
  int8_t Y1 = ( Wire.read()| Wire.read() << 8); // Y-axis value
  int8_t Z1 = ( Wire.read()| Wire.read() << 8); // Z-axis value
  Wire.endTransmission();
...
// ------------------------------
  ...
  int8_t X2 = (( Wire.read()| Wire.read() << 8)); // X-axis value
  int8_t Y2 = (( Wire.read()| Wire.read() << 8)); // Y-axis value
  int8_t Z2 = (( Wire.read()| Wire.read() << 8)); // Z-axis value
  Wire.endTransmission();
...
// ------------------------------
  ...
  int8_t X3 = ( Wire.read()| Wire.read() << 8); // X-axis value
  int8_t Y3 = ( Wire.read()| Wire.read() << 8); // Y-axis value
  int8_t Z3 = ( Wire.read()| Wire.read() << 8); // Z-axis value
  Wire.endTransmission();
...
// ------------------------------
  ...
  int8_t X4 = ( Wire.read()| Wire.read() << 8); // X-axis value
  int8_t Y4 = ( Wire.read()| Wire.read() << 8); // Y-axis value
  int8_t Z4 = ( Wire.read()| Wire.read() << 8); // Z-axis value
  Wire.endTransmission();
